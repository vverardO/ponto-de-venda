<div class="mt-5">
    <div class="mb-4 flex flex-row">
        ...
        <a href="{{route('create-product')}}" wire:navigate class="ml-3 px-4 py-2 text-sm font-medium text-center text-white bg-emerald-700 rounded-lg hover:bg-emerald-800 focus:outline-none dark:bg-emerald-600 dark:hover:bg-emerald-700">+</a>
    </div>
    @forelse($products as $product)
        <a class="bg-white rounded-lg flex-row p-3 mb-3 flex justify-between hover:border-2 hover:cursor-pointer" wire:navigate href="{{route('update-product', ['product' => $product])}}">
