                ...
                <div class="ml-4 flex items-center md:ml-6">
                    <div class="relative ml-3">
                        ...
                        <div x-show="menu" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            <a href="" wire:navigate class="@if(request()->routeIs('profile*')) text-gray-700 bg-gray-200 @else text-gray-300 @endif block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-0">Perfil</a>
                            @else
                            @endif
    ...
    <div class="md:hidden" x-show="mobile_menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="mt-3 space-y-1 px-2">
                @if(auth()->user()->type == 'manager')
                <a href="" wire:navigate class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Perfil</a>
                @else
                @endif
            </div>
        </div>
